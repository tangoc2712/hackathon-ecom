                ...
                <tbody>
                  {cartItems.map((item) => (
                    <tr className="border-b" key={item.productId}>
                      <td className="p-4">
                        <Link to={`/product/${item.productId}`}>
                          <div className="flex items-center space-x-4">
                            <img
                              src={item.photo || (item.photos && item.photos.length > 0 ? item.photos[0] : 'https://via.placeholder.com/150')}
                              alt="Product"
                      ...
                      <td className="p-4">{item.currency} {Number(item.price).toFixed(2)}</td>
                      <td className="p-4">
                      ...
                      <td className="p-4">{item.currency} {(Number(item.price) * item.quantity).toFixed(2)}</td>
                      <td className="p-4">
                        <button
