                        ...
                        {products.map(product => (
                            <tr key={product.product_id} className="hover:bg-gray-100">
                                <td className="py-3 px-4 border-b border-gray-300">
                                    <img src={product.photo || (product.photos && product.photos.length > 0 ? product.photos[0] : '')} alt={product.name} className="w-16 h-16 object-cover rounded" />
                                </td>
                                <td className="py-3 px-4 border-b border-gray-300 text-sm">{product.product_id}</td>
                                ...
                                <td className="py-3 px-4 border-b border-gray-300">
                                    <button
                                        ...
                                        onClick={() => handleFeatureToggle(product.product_id)}
                                    >
                                        Remove
                                    </button>
                                </td>
